...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _stringify = __webpack_require__(/*! babel-runtime/core-js/json/stringify */ \"./node_modules/babel-runtime/core-js/json/stringify.js\");\n\nvar _stringify2 = _interopRequireDefault(_stringify);\n\nvar _typeof2 = __webpack_require__(/*! babel-runtime/helpers/typeof */ \"./node_modules/babel-runtime/helpers/typeof.js\");\n\nvar _typeof3 = _interopRequireDefault(_typeof2);\n\nvar _dsbridge = __webpack_require__(/*! dsbridge */ \"./node_modules/dsbridge/index.js\");\n\nvar _dsbridge2 = _interopRequireDefault(_dsbridge);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// 新模块跳转老模块\nvar newToOriginModule = function newToOriginModule(pageName) {\n  var direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'push';\n  var otherParams = arguments[2];\n\n  var params = {\n    pageName: pageName,\n    direction: direction\n  };\n  if (typeof otherParams === 'string') {\n    if (/\\&[\\w\\W]*=[\\w\\W]*/.test(otherParams)) {\n      params.otherParams = otherParams;\n    } else {\n      console.warn('otherParams类型与要求不符');\n      return false;\n    }\n  }\n  if ((typeof otherParams === 'undefined' ? 'undefined' : (0, _typeof3.default)(otherParams)) === 'object') {\n    var temp = '';\n    for (var key in otherParams) {\n      temp = '&' + key + '=' + otherParams[key];\n    }\n    params.otherParams = temp;\n  }\n  return _dsbridge2.default.call('origin.newToOriginModule', params);\n};\n\n// 老模块跳转新模块\n/*\n * @Author: Yu Xin\n * @Date: 2020-12-08 19:50:51\n * @LastEditors: Yu Xin\n * @LastEditTime: 2020-12-09 12:38:02\n * @Description: file content\n */\nvar originToNewModule = function originToNewModule(url) {\n  var direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'push';\n  var otherParams = arguments[2];\n\n  if ((typeof otherParams === 'undefined' ? 'undefined' : (0, _typeof3.default)(otherParams)) !== 'object') {\n    console.warn('otherParams必须为对象');\n    return false;\n  }\n\n  var u = navigator.userAgent;\n  var isAndroid = u.indexOf('Android') > -1 || u.indexOf('Adr') > -1; //android终端\n  var isiOS = !!u.match(/\\(i[^;]+;( U;)? CPU.+Mac OS X/); //ios终端\n\n  if (isiOS && plus) {\n    var params = {\n      url: url,\n      direction: direction,\n      otherParams: otherParams\n    };\n    var notiClass = plus.ios.importClass(\"NSNotificationCenter\");\n    notiClass.defaultCenter().postNotificationNameobject(\"originToNewModule\", (0, _stringify2.default)(params));\n  }\n  if (isAndroid && android) {\n    window.android.originToNewModule(url, direction, otherParams);\n  }\n};\n\nvar moduleJump = {\n  newToOriginModule: newToOriginModule,\n  originToNewModule: originToNewModule\n};\n\nexports.default = moduleJump;\n\n//# sourceURL=webpack://sbridge/./src/moduleJump/index.js?");
